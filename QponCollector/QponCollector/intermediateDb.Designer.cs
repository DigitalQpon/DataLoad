...
namespace QponCollector {
    ...
    public partial class intermediateDb : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.tableProsperentMerchant = new ProsperentMerchantDataTable();
...
namespace QponCollector.intermediateDbTableAdapters {
...
SELECT nCouponID, cMerchant, nMerchantID, nMasterMerchantID, cNetwork, cStatus, cLabel, cImage, cRestrictions, cCode, dtStartDate, dtEndDate, cLastUpdated, cCreated, cAffiliateURL, cDirectURL, cSkimlinksURL, cFMTCURL, aTypes, fSalePrice, fWasPrice, fDiscount, nPercent, createdOn, updatedOn, updateStatus, updateUser FROM FmtcDeals WHERE (nCouponID = @nCouponID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::QponCollector.Properties.Settings.Default.intermediate_qponcrush_dbConnectionString;
        }
...
SELECT merchant, merchantId, logoUrl, image_url, domain, category, productDatafeed, numProducts, numProductsCA, numProductsUK, numCouponsUs, numLocalDealsUS, numTravelOffersUS, minPaymentPercentage, maxPaymentPercentage, averagePaymentPercentage, conversionRate, epc, merchantWeight, dateActive, createdOn, updatedOn, updateStatus, updateUser, vendorId FROM ProsperentMerchant WHERE (merchantId = @merchantId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT merchant, merchantId, logoUrl, image_url, domain, category, productDatafeed, numProducts, numProductsCA, numProductsUK, numCouponsUs, numLocalDealsUS, numTravelOffersUS, minPaymentPercentage, maxPaymentPercentage, averagePaymentPercentage, conversionRate, epc, merchantWeight, dateActive, createdOn, updatedOn, updateStatus, updateUser, vendorId FROM dbo.ProsperentMerchant";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(intermediateDb.ProsperentMerchantDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual intermediateDb.ProsperentMerchantDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            intermediateDb.ProsperentMerchantDataTable dataTable = new intermediateDb.ProsperentMerchantDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(intermediateDb.ProsperentMerchantDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
